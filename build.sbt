...
ThisBuild / organization := "org.theorganization"
...
lazy val shared = crossProject(JSPlatform, JVMPlatform)
  ...
  .in(file("shared"))
  .settings(
    name := """scala-krop-project-shared""",
    commonSettings,
...
lazy val backend = project
  .in(file("backend"))
  .settings(
    name := """scala-krop-project-backend""",
    commonSettings,
    libraryDependencies ++= Seq(
...
lazy val frontend = project
  .in(file("frontend"))
  .settings(
    name := """scala-krop-project-frontend""",
    commonSettings
  )
